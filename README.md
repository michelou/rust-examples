...
- [Rust 1.61][rust_downloads] <sup id="anchor_01"><a href="#footnote_01">1</a></sup> ([*release notes*][rust_relnotes])
...
Tool versions:
   ...
   pelook v1.73, git 2.36.1.windows.1, diff 3.8, bash 4.4.23(1)-release
&nbsp;
